            ...
            {reasons.map((reason, index) => {
              ...
              return (
                <Reveal key={reason.title} delay={index * 0.08}>
                  <article className="h-full rounded-lg bg-white p-6 shadow-crisp">
          ...
          <div className="mt-12 grid gap-5 lg:grid-cols-4">
            {process.map((step, index) => (
              <Reveal key={step} delay={index * 0.08}>
                <div className="relative h-full rounded-lg border border-brand-line bg-white p-6 shadow-crisp">
