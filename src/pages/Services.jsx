  ...
  return (
    <>
      <section className="section bg-[linear-gradient(135deg,#ffffff,#f5f8fc)]">
        <div className="container-page">
          <Reveal className="max-w-3xl">
            ...
            <h1 className="mt-3 text-4xl font-extrabold leading-tight sm:text-6xl">Digital growth services with a clear business purpose.</h1>
          ...
          {services.map((service, index) => {
            ...
            return (
              <Reveal key={service.title} delay={index * 0.05}>
                <article className="grid gap-8 rounded-lg border border-brand-line bg-white p-6 shadow-crisp md:grid-cols-[0.8fr_1.2fr] md:p-8">
                  <div>
                    <div className="inline-flex h-12 w-12 items-center justify-center rounded-md bg-blue-50 text-xl text-brand-blue">
                      <Icon />
                    </div>
                  ...
                  <div className="grid content-center gap-3">
                    {benefits[service.title].map((benefit) => (
                      <div key={benefit} className="flex items-center gap-3 rounded-md bg-brand-cloud p-4 text-sm font-bold text-slate-700">
      ...
      <section className="section bg-brand-cloud">
        <Reveal className="container-page flex flex-col items-start justify-between gap-6 rounded-xl bg-white p-8 shadow-premium md:flex-row md:items-center">
          <div>
